...
const requiredProductionFiles = [
  ...
  "api/_admin/project-site-control.js",
  "api/_admin/lifecycle.js",
  "api/_admin/execution.js",
  "api/_admin/project-site-journal.js",
  "api/_admin/procurement-plans.js",
  ...
  "api/_lib/project-site-control.js",
  "api/_lib/project-site-journal.js",
  "api/_lib/lifecycle.js",
  "api/_lib/project-execution.js",
  "api/_lib/ai-foundation.js",
  "api/_lib/ai-offer-comparison.js",
  "api/_lib/cloud-backup.js",
  "api/_lib/commercial-launch.js",
  "api/_lib/crm.js",
  ...
  "api/_lib/estimate-workflow.js",
  "api/_lib/procurement-plan.js",
  ...
  "tests/site/ai-phase-four.test.mjs",
  "tests/site/ai-phase-five.test.mjs",
  "tests/site/ai-phase-six.test.mjs",
  ...
  "db/migrations/025_commercial_proposals.sql",
  "db/migrations/026_supplier_launch_controls.sql",
  "db/migrations/027_launch_operations.sql",
  "db/migrations/028_ai_foundation.sql",
  "db/migrations/029_ai_catalog_rfq.sql",
  ...
  "db/migrations/034_project_site_control.sql",
  "db/migrations/035_project_site_journal.sql",
  "db/migrations/036_procurement_three_way_control.sql",
  "db/migrations/037_asset_lifecycle_center.sql",
  "db/migrations/038_project_execution_payments.sql",
