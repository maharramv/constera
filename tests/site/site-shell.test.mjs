...
test("checkout indekslənmir və PWA şəxsi/API sorğularını keşləmir", () => {
  ...
  for (const page of ["admin.html", "checkout.html", "customer-cabinet.html", "project-planner.html", "login.html", "order-detail.html", "proposal-detail.html", "price-import.html", "rfq-dashboard.html", "supplier-portal.html"]) {
